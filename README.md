...
1. What are the main differences between a stateful and a functional component?
  ...
  - A stateful component implements logic, state, and UI while a functional component mainly renders UI. 

2. When does a componentWillMount function be called? What about a componentWillUpdate?

  - componentWillMount is called before mounting and before render, it can be used to set values into state. componentWillUpdate is considered legacy, but was invoked just before rendering when new props or state are being received. 

3. Define stateful logic.

 - Stateful logic is a function or any type of logic that deals with handling state.

4. What are the three step of creating a successful test? What is done in each phase?

 - The three steps are arrange, act, assert. In the arrange step, you ensure that you render the component. In the assert step, you ensure that your elements are being rendered by your component and you can input text in input fields. In assert, you ensure that the values you submitted in the act step are in the document. 